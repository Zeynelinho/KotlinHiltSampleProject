package com.zeynelinho.artbooktesting.adapter
...
class ImageRecyclerAdapter @Inject constructor(
    ...
    private val deffUtil = object : DiffUtil.ItemCallback<String>() {
    ...
    private val recyclerListDiffer = AsyncListDiffer(this,deffUtil)
